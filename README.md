# Frontend Take-Home Exercise at Fetch Rewards
...
Occupation
State
Occupation and State should allow users to select from options returned by an endpoint. Users should only be able to select one occupation and one state. [A GET request](https://frontend-take-home.fetchrewards.com/form) will return a JSON body with the following format:
